...
const db = require('APP/db')
    , {User, Thing, Favorite, Developer, Category, Promise} = db
...
const devCat = seed(DeveloperCategory,
  ({ developers, categories }) => ({
    'Joe loves Web': {
      developer_id: developers.Joe.id, // users.baracjk is an instance of the User model
      category_id: categories.WebDev.id // Same thing for things.
    },
  })
);
...
module.exports = Object.assign(seed, {users, things, favorites, devCat})
